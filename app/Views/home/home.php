<div class="container">
    ...
    <div class="row text-center my-5">
        <div class="col">
            ...
            <?php
            if ($usaha['status'] == 1) { ?>
                <a href="usaha/1" class="btn mx-3 fs-1" style="background-color: #ffee93; height: 100px; width: 300px; font-family: Lucidatypewriter;">
            ...
            if ($tuaspengungkit['status'] == 1) { ?>
                <a href="tuas/1" class="btn mx-3 fs-1" style="background-color: #d4afb9; height: 100px; width: 300px;font-family: Lucidatypewriter;">
            ...
            if ($bidangmiring['status'] == 1) { ?>
                <a href="bidang/1" class="btn mx-3 fs-1" style="background-color: #7ec4cf; height: 100px; width: 300px;font-family: Lucidatypewriter;">
    ...
    <div class="row text-center my-5">
        <div class="col">
            ...
            if ($katrol['status'] == 1) { ?>
                <a href="katrol/1" class="btn mx-3 fs-1" style="background-color: #ffc09f; height: 100px; width: 300px;font-family: Lucidatypewriter;">
            ...
            if ($rodabergerigi['status'] == 1) { ?>
                <a href="roda/1" class="btn mx-3 fs-1" style="background-color: #adf7b6; height: 100px; width: 300px;font-family: Lucidatypewriter;">
            ...
            <?php $rule = session()->get('rule');
            if ($gaya['status'] == 1) { ?>
                <a href="gaya/1" class="btn mx-3 fs-1" style="background-color: #adf7b6; height: 100px; width: 300px;font-family: Lucidatypewriter;">
