            ...
            <div>
                <form action="/datauser/save" method="post" enctype="multipart/form-data">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input name="nama_user" type="text" class="form-control <?= ($validation->hasError('nama_user')) ? 'is-invalid' : ''; ?>" id="nama_user" autofocus>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input name="alamat_user" type="text" class="form-control <?= ($validation->hasError('alamat_user')) ? 'is-invalid' : ''; ?>" id="alamat_user">
                            <div class="invalid-feedback">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <select class="custom-select mr-sm-2" id="rule" name="rule">
                                ...
                                <option value="1"> Adminisitrator</option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input name="password" type="password" class="form-control <?= ($validation->hasError('password')) ? 'is-invalid' : ''; ?>" id="password">
                            <div class="invalid-feedback">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input name="no_hp" type="text" class="form-control <?= ($validation->hasError('no_hp')) ? 'is-invalid' : ''; ?>" id="no_hp">
                            <div class="invalid-feedback">
